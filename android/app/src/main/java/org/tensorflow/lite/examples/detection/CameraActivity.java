...
public abstract class CameraActivity extends AppCompatActivity
  ...
  // Added to allow taking snapshot when human detected
  public static boolean faceDetected = false;
  public boolean runnable = false;
  protected ImageView screenshot; // screenshot view
...
//    getSupportActionBar().setDisplayShowTitleEnabled(false);
  ...
  public synchronized void onStart() {
    ...
    mSharedPreference.getString(RtspServer.KEY_PORT, "1234");
  ...
  protected int getScreenOrientation() {
    switch (getWindowManager().getDefaultDisplay().getRotation()) {
      ...
      case Surface.ROTATION_90:
        return 90;
      default:
        return 90; // need to be 90 for cruzr, default is 0. for camera screenshot
    }
  }
