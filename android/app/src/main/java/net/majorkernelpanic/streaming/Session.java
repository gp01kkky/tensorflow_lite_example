...
public class Session {
	...
	public void syncConfigure()
		...
		mVideoStream.setStreamingMethod(MediaStream.MODE_MEDIACODEC_API);
	...
	public void syncStart(int id)
		...
		if (stream!=null && !stream.isStreaming()) {
			try {
				...
				stream.start();
				// set the camera as it is a public oobject (changed from videostream class)
	...
	/*public void saveSegment (boolean endOfStream){
		//mVideoStream.endOfStream = endOfStream;
		//mVideoStream.saveSegment();
	}*/
