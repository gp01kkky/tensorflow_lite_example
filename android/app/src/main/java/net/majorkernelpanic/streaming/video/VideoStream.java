...
*/
	 ...
	 */
	protected void encodeWithMediaCodec(Camera camera) throws RuntimeException, IOException {
...
//		mMuxer.start();
		...
		if (mMode == MODE_MEDIACODEC_API_2) {
			...
			encodeWithMediaCodecMethod1(camera);
		}
	}	
...
//	public boolean endOfStream = false;
	 ...
	 */
	@SuppressLint("NewApi")
	protected void encodeWithMediaCodecMethod1(Camera camera) throws RuntimeException, IOException {
